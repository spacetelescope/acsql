...
project is named \texttt{acsql} and is hosted on \texttt{GitHub}, a repository hosting service[15].  The repository is publicly available at \textcolor{blue}{\url{http://github.com/spacetelescope/acsql/}}.
...
\caption{\textit{An example of the \texttt{PEP257} and \texttt{numpydoc} docstring conventions,
...
\texttt{acsql} is hosted at \textcolor{blue}{\url{http://acsql.readthedocs.io/}}.  The output documentation
...
\caption{\textit{The \texttt{readthedocs} documentation for the \texttt{acsql} example function
seen in Figure N.}}
\label{fig6}
\end{figure}
...
\caption{\textit{A representation of the directory structure within the \texttt{acsql} filesystem,
...
\caption{\textit{An example of a \texttt{JPEG} image (left) and its corresponding
...
\caption{\textit{A representation of the directory structure for the \texttt{JPEG} (left)
...
\caption{\textit{The \texttt{load$\_$conenction} function, which is used to build a connection to the
...
\caption{\textit{The contents of an example text file used to define the columns of a header table in the
...
\caption{\textit{An example of how the \texttt{orm$\_$factory} function is called to create class
...
\caption{\textit{The \texttt{insert$\_$or$\_$update} function from the \texttt{acsql.utils.utils}
...
\caption{\textit{The results of the database query shown in Figure N in the form of an HTML
table.}}
\label{fig23}
\end{figure}
...
\caption{\textit{The results of the database query shown in Figure N in the form of an CSV
file.}}
\label{fig24}
\end{figure}
...
\caption{\textit{The results of the database query shown in Figure N in the form of thumbnail
images.}}
\label{fig25}
\end{figure}
...
API documentation hosted at \textcolor{blue}{\url{http://acsql.readthedocs.io/}}.
...
\textcolor{blue}{\url{https://archive.stsci.edu/}}).  The location of the filesystem is determined by the \texttt{filesystem} parameter in
...
and is avilable to download directly from the \texttt{GitHub} repository (\textcolor{blue}{\url{http://github.com/acsql/}}).  All
...
but are also hosted on \texttt{readthedocs}, available at \textcolor{blue}{\url{http://acsql.readthedocs.io/}}.  This is considered
