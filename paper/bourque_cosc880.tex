...
metadata of each observation, (3) A Python/\texttt{Flask}-based web application
for interacting with the filesystem and database, and (4) A Python code library
that contains code for connecting to the database, ingesting new
...
work for the ACS instrument team at STScI.  However, the application is not limited to this
...
The \texttt{acsql} was designed with four main use cases in mind, each briefly described below.
