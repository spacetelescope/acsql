...
\subsubsection{Including proprietary data in the \texttt{acsql} filesystem}

\subsubsection{Building automated instrument calibration and monitoring routines}

\subsubsection{Expanding the database query form}

\subsubsection{Adding a script execution status dashboard}

\subsubsection{Tracking ACS image anomalies}


\subsection{Possible extensions to other instruments or missions} \label{sec5.2}

\subsubsection{STIS CCD}

Imaging instruments

\subsubsection{James Webb Space Telescope}

Talk about IR up the read
...
\noindent \hyperlink{page.1}{\texttt{LICENSE}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{README.md}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{MANIFEST.in}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{setup.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{docs.Makefile}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{docs/requirements.txt}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{docs/source/conf.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{docs/source/database.rst}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{docs/source/index.rst}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{docs/source/ingest.rst}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{docs/source/scripts.rst}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{docs/source/utils.rst}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{docs/source/website.rst}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/database/database$\_$interface.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/database/make$\_$tabledefs.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/database/queries.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/database/reset$\_$database.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/database/update$\_$tabledefs.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/ingest/ingest.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/ingest/make$\_$file$\_$dict.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/ingest/make$\_$jpeg.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/ingest/make$\_$thumbnail.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/scripts/ingest$\_$production.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/utils/utils.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/acsql$\_$webapp.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/data$\_$containers.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/form$\_$options.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/query$\_$form.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/query$\_$lib.py}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/templates/404.html}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/templates/500.html}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/templates/$\_$formhelpers.html}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/templates/archive.html}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/templates/base.html}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/templates/database.html}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/templates/database$\_$error.html}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/templates/database$\_$table.html}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/templates/header.html}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/templates/index.html}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/templates/view$\_$image.html}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/templates/view$\_$proposal.html}} \dotfill 1\\
\noindent \hyperlink{page.1}{\texttt{acsql/website/templates/view$\_$query$\_$results.html}} \dotfill 1\\
