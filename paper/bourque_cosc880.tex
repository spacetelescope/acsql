...
As described in Section 3.9, the \texttt{acsql} web application consists of a series of Python modules
...
(2) have installed the Python package dependencies, and (3) have filled out the \texttt{config.yaml}
...
Include proprietart data
Build automated calibration and monitoring scripts
Add capabilities to query form
