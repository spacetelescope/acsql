...
\texttt{crc} files, which is also unsurprising considering that these filetypes are only triggered for specific observing modes.
...
features to be added to the application, namely those present in the \texttt{wfc3ql} application, discussed in chapter \ref{chap2}.  Furthermore, some or all of the \texttt{acsql} application
